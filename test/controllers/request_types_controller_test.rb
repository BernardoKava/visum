...
class RequestTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request_type" do
    assert_difference('RequestType.count') do
      post request_types_url, params: { request_type: { active: @request_type.active, description: @request_type.description, name: @request_type.name, notes: @request_type.notes, user_id: @request_type.user_id } }
    end
  ...
  test "should update request_type" do
    patch request_type_url(@request_type), params: { request_type: { active: @request_type.active, description: @request_type.description, name: @request_type.name, notes: @request_type.notes, user_id: @request_type.user_id } }
