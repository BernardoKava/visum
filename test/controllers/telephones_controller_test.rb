...
class TelephonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telephone" do
    assert_difference('Telephone.count') do
      post telephones_url, params: { telephone: { active: @telephone.active, person_id: @telephone.person_id, phone: @telephone.phone, user_id: @telephone.user_id } }
    end
  ...
  test "should update telephone" do
    patch telephone_url(@telephone), params: { telephone: { active: @telephone.active, person_id: @telephone.person_id, phone: @telephone.phone, user_id: @telephone.user_id } }
