...
class ServiceProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_provider" do
    assert_difference('ServiceProvider.count') do
      post service_providers_url, params: { service_provider: { acc_number: @service_provider.acc_number, active: @service_provider.active, address: @service_provider.address, email: @service_provider.email, link: @service_provider.link, name: @service_provider.name, telephone: @service_provider.telephone, user_id: @service_provider.user_id } }
    end
  ...
  test "should update service_provider" do
    patch service_provider_url(@service_provider), params: { service_provider: { acc_number: @service_provider.acc_number, active: @service_provider.active, address: @service_provider.address, email: @service_provider.email, link: @service_provider.link, name: @service_provider.name, telephone: @service_provider.telephone, user_id: @service_provider.user_id } }
