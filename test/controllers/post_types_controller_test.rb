...
class PostTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_type" do
    assert_difference('PostType.count') do
      post post_types_url, params: { post_type: { active: @post_type.active, description: @post_type.description, name: @post_type.name, user_id: @post_type.user_id } }
    end
  ...
  test "should update post_type" do
    patch post_type_url(@post_type), params: { post_type: { active: @post_type.active, description: @post_type.description, name: @post_type.name, user_id: @post_type.user_id } }
