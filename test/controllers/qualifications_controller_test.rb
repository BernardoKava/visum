...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { active: @qualification.active, from: @qualification.from, grade: @qualification.grade, name: @qualification.name, person_id: @qualification.person_id, school: @qualification.school, to: @qualification.to, user_id: @qualification.user_id } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { active: @qualification.active, from: @qualification.from, grade: @qualification.grade, name: @qualification.name, person_id: @qualification.person_id, school: @qualification.school, to: @qualification.to, user_id: @qualification.user_id } }
