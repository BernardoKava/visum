...
class ExpensesTest < ApplicationSystemTestCase
  ...
  test "creating a Expense" do
    ...
    fill_in "Budget", with: @expense.budget_id
    fill_in "Details", with: @expense.details
    fill_in "Expense type", with: @expense.expense_type
    fill_in "Month", with: @expense.month
    fill_in "Outflowtype", with: @expense.outflowtype_id
    fill_in "Owner", with: @expense.owner
    fill_in "Person", with: @expense.person_id
