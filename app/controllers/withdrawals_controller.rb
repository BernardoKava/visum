class WithdrawalsController < ApplicationController
  ...
  private
    ...
    def withdrawal_params
      params.require(:withdrawal).permit(:owner, :amount, :details, :user_id, :saving_id, :institution, :month, :year, :person_id, :financialinstitution_id, :origination, :rationale, :day, :plannedactivity_id)
    end
end
