class EmploymentsController < ApplicationController
  ...
  private
    ...
    def employment_params
      params.require(:employment).permit(:company, :position, :from, :to, :terminationreason, :actve, :person_id, :user_id, :company_address, :company_telephone, :company_email, :company_details, :role)
    end
end
